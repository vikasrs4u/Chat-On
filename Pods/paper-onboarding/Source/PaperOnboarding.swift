...
open class PaperOnboarding: UIView {
    ...
    fileprivate var pageViewSelectedRadius: CGFloat = 14
    ...
    public init(pageViewBottomConstant: CGFloat = 20) {
    ...
    public required init?(coder aDecoder: NSCoder) {
        ...
        self.pageViewBottomConstant = 4
        self.pageViewSelectedRadius = 9
